...
function Nameplates:BuildAurasTab(content, configKey, disabled)
    ...
    if not config.debuffs then
        config.debuffs = {
            ...
            showStacks = true, showBorder = true, colorByDispelType = true,
        }
    end
    if not config.buffs then
        config.buffs = {
            ...
            showDuration = true, showStacks = true, showBorder = true, colorByDispelType = true,
        }
    end
    ...
    yOffset = self:CreateAuraSlider(content, yOffset, "Icon Size:", debuffConfig, "iconSize", 12, 40, 1, disabled)
    ...
    yOffset = self:CreateAuraSlider(content, yOffset, "Icon Size:", buffConfig, "iconSize", 12, 40, 1, disabled)
