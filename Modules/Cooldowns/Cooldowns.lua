...
local function UpdateCustomTrackerCooldown(iconFrame)
    ...
    elseif trackType == "spell" then
        -- =====================================================================
        -- SPELL COOLDOWN (v2.0.0 - Using SpellAPI wrapper)
        -- =====================================================================
        
        -- Use SpellAPI to apply cooldown via Duration Object
        local cooldownSet = SpellAPI:ApplyCooldownToFrame(iconFrame.cooldown, trackID, true)
        
        if not cooldownSet then
            iconFrame.cooldown:Clear()
        end
        
        -- Update charges using SpellAPI
        local chargesInfo = SpellAPI:GetChargesInfo(trackID)
        if chargesInfo and chargesInfo.currentCharges then
            if chargesInfo.maxCharges > 1 then
...
function Cooldowns:CreateTrackerPanel(trackerKey)
    ...
    local function BuildHighlightsTab(parent)
        ...
        controls.cooldownTextHeader:SetPoint("TOPLEFT", 10, -305)
        ...
        controls.cooldownTextScaleLabel:SetPoint("TOPLEFT", 10, -325)
        ...
        controls.cooldownTextColorLabel:SetPoint("TOPLEFT", 10, -350)
        ...
        controls.cooldownTextOffsetXLabel:SetPoint("TOPLEFT", 10, -375)
        ...
        controls.cooldownTextOffsetYLabel:SetPoint("TOPLEFT", 10, -400)
        ...
        controls.countTextHeader:SetPoint("TOPLEFT", 10, -430)
        ...
        controls.countTextScaleLabel:SetPoint("TOPLEFT", 10, -450)
        ...
        controls.countTextColorLabel:SetPoint("TOPLEFT", 10, -475)
        ...
        controls.countTextOffsetXLabel:SetPoint("TOPLEFT", 10, -500)
        ...
        controls.countTextOffsetYLabel:SetPoint("TOPLEFT", 10, -525)
...
function Cooldowns:CreateCustomTrackersPanel()
    ...
    local function BuildPerIconTab(parent)
        ...
        local function RefreshSlotList()
            ...
            -- Sort by listIndex to match layout order (LayoutCustomTrackerIcons uses listIndex)
            table.sort(icons, function(a, b)
                return (a.listIndex or 0) < (b.listIndex or 0)
            end)
